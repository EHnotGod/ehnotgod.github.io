...
![image-20250727163932059](/images/算法竞赛/D/D8-1.png)

### 算法解析：

Tarjan 离线求 LCA：DFS 遍历树，回溯时把当前点并入其父节点所在的集合（并查集）。当某个询问的两个点都已被访问到时，它们的 LCA 就是其中一个点在并查集中的根。离线处理所有询问，总复杂度 $O((n+m)\alpha)$。
