...
export const theme: ThemeUserConfig = {
  ...
  description: 'EH is not god, but EH',
  description_en: 'EH is not god, but EH',
  ...
  footer: {
    ...
    social: { github: 'https://github.com/ehnotgod' }
  },
  ...
  personal: {
    ...
    /** Your email address */
    email: '19859758280@163.com',
    /** Your Google Scholar profile URL */
    googleScholar: '',
    /** Blog start date for statistics */
    blogStartDate: '2026-08-08',
    /** Domain configuration */
    domains: {
      main: 'ehnotgod.github.io',
      githubPages: 'ehnotgod.github.io',
      // cloudflare: '',
      // friendCircle: '',
    },
  }
